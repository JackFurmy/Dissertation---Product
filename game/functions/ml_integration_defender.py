...
DEFENDER_SCENARIOS: Dict[str, Dict[str, Any]] = { 
    ...
    "linux/process": {
        "val": "https://firebasestorage.googleapis.com/v0/b/mldiss.firebasestorage.app/o/Incremental%2FLinux%2FProcess%2Fval_starting.csv?alt=media&token=3382a7f6-14b0-4a95-a253-f66947fcd3f5",
        "chunks": [
    ...
    "linux/disk": {
        "val": "https://firebasestorage.googleapis.com/v0/b/mldiss.firebasestorage.app/o/Incremental%2FLinux%2FDisk%2Fval_starting.csv?alt=media&token=86d69c38-903f-4de5-b2a1-cc3a6ea3e308",
        "chunks": [
    ...
    "windows/windows7": {
        "val": "https://firebasestorage.googleapis.com/v0/b/mldiss.firebasestorage.app/o/Incremental%2FWindows%2FWindows%207%2Fval_starting.csv?alt=",
        "chunks": [
