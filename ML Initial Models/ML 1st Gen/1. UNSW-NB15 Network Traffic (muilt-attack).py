...
TRAIN_DATA_PATH = "/Users/jackfurmston/developer/cybersecurity_game/data/Network Traffic Data/Institutional/UNSW-NB15/Training and Testing Sets/unsw_training_final_validated.csv"
HISTORICAL_FILE = "/Users/jackfurmston/developer/cybersecurity_game/models/1. Baseline Offline Model/Network Traffic (multi-attack)/unsw-nb15_historical.xlsx"
...
def plot_mutual_info(X, y):
    ...
    plt.title("Feature 'Leakage' Score via MI - UNSW-NB15")
    plt.tight_layout()
    plt.show()
