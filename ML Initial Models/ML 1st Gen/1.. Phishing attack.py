...
TRAIN_DATA_PATH = (
    "cybersecurity_game/data/Phishing Websites/Phishing Attack URL - non institutional/dataset/small/feature_engineered/train_step3_tfidf.csv"
)
...
def plot_mutual_info(X, y):
    ...
    plt.title("Feature 'Leakage' Score - TF-IDF Phishing")
    plt.tight_layout()
    plt.show()
