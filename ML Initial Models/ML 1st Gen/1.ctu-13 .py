...
TRAIN_DATA_PATH = "cybersecurity_game/data/Malware Attack Patterns/Institutional/CTU-13 Botnet Dataset/CTU13_train_10p.csv"
HISTORICAL_FILE = "cybersecurity_game/models/1. Baseline Offline Model/Network traffic:Botnet/ctu-13_historical.xlsx"
...
LEAKY_COLUMNS = [
    "StartTime",
    "SrcAddr_oct1", "SrcAddr_oct2", "SrcAddr_oct3", "SrcAddr_oct4",
    "DstAddr_oct1", "DstAddr_oct2", "DstAddr_oct3", "DstAddr_oct4"
]
...
def plot_mutual_info(X, y):
    ...
    if X_num.shape[1] < 1:
        print("[WARN] No numeric columns to compute MI.")
        return None
    ...
    plt.title("Feature 'Leakage' Score via MI - CTU-13")
    plt.tight_layout()
    plt.show()
