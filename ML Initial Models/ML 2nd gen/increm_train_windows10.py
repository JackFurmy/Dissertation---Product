...
def bundle_path() -> Path:
    return MODEL_DIR / "windows10.pkl"
...
def train_windows10(
    ...
    user_id       : str  = "win10_default_user",
):
    prev_models = {}
    ...
    for x, y, feats in stream_rows(WINDOWS10_FIREBASE_URL,
    ...
    joblib.dump(
        {
            ...
            "best_name":    best_name,
            "best_f1":      best_f1,
            "dataset_url":  WINDOWS10_FIREBASE_URL,
            "rows_trained": rows,
        },
        bundle_path(),
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--user-id",       default="win10_default_user")
    args = ap.parse_args()
