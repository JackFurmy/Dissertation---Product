...
def stream_rows(
    ...
    print("[INFO] downloading IoT‑GPS‑Tracker CSV …")
    df = (
...
def bundle_path() -> Path:
    return MODEL_DIR / "iot_gps_tracker.pkl"
...
def train_iot_gps(
    ...
    for x_raw, y in stream_rows(IOT_GPS_FIREBASE_URL, chunk_size, label_encoders):
        rows += 1
    ...
    joblib.dump(
        {
            ...
            "best_name":  best_name,
            "best_f1":    best_f1,
            "dataset_url": IOT_GPS_FIREBASE_URL,
        },
        bundle_path(),
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--user-id",       default="gps_default_user")
    args = ap.parse_args()
