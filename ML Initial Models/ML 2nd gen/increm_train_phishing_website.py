...
def bundle_path() -> Path:
    return MODEL_DIR / "phishing_websites.pkl"
...
def train_phishing_web(
    chunk_size    : int  = 50_000,
    load_existing : bool = False,
    split_models  : bool = False,
    user_id       : str  = "phishing_50p_default_user",
):
    prev_models = {}
    ...
    for x, y, feats in stream_rows(PHISHING_50P_FIREBASE_URL,
    ...
    joblib.dump(
        {
            ...
            "best_name":    best_name,
            "best_f1":      best_f1,
            "dataset_url":  PHISHING_50P_FIREBASE_URL,
            "rows_trained": rows,
        },
        bundle_path(),
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--user-id",       default="phishing_50p_default_user")
    args = ap.parse_args()
