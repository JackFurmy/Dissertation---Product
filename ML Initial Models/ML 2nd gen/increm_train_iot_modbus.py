...
def stream_rows(
    ...
    print("[INFO] downloading IoT‑Modbus CSV …")
    df = (
...
def bundle_path() -> Path:
    return MODEL_DIR / "iot_modbus.pkl"
...
def train_iot_modbus(
    chunk_size: int = 50_000,
    load_existing: bool = False,
    split_models: bool = False,
    user_id: str = "modbus_default_user",
):
    prev_models = {}
    ...
    for x_raw, y in stream_rows(IOT_MODBUS_FIREBASE_URL, chunk_size, label_encoders):
        rows += 1
    ...
    joblib.dump(
        {
            ...
            "best_name":  best_name,
            "best_f1":    best_f1,
            "dataset_url": IOT_MODBUS_FIREBASE_URL,
        },
        bundle_path(),
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--user-id",       default="modbus_default_user")
    args = ap.parse_args()
