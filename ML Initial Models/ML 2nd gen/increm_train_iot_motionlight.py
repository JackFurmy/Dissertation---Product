...
def stream_rows(
    ...
    print("[INFO] downloading IoT‑Motion‑Light CSV …")
    df = (
...
def bundle_path() -> Path:
    return MODEL_DIR / "iot_motion_light.pkl"
...
def train_iot_motion_light(
    chunk_size: int = 50_000,
    load_existing: bool = False,
    split_models: bool = False,
    user_id: str = "motion_default_user",
):
    prev_models = {}
    ...
    for x_raw, y in stream_rows(IOT_ML_FIREBASE_URL, chunk_size, label_encoders):
        rows += 1
    ...
    joblib.dump(
        {
            ...
            "best_name":  best_name,
            "best_f1":    best_f1,
            "dataset_url": IOT_ML_FIREBASE_URL,
        },
        bundle_path(),
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--user-id",       default="motion_default_user")
    args = ap.parse_args()

    train_iot_motion_light(
