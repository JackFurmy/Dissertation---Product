...
def stream_rows(
    ...
    print("[INFO] downloading Linux‑process CSV …")
    df = (
...
def bundle_path() -> Path:
    return MODEL_DIR / "linux_process.pkl"
...
def train_linux_process(
    chunk_size: int = 50_000,
    load_existing: bool = False,
    split_models: bool = False,
    user_id: str = "linux_process_user",
):
    prev_models = {}
    ...
    for x_raw, y in stream_rows(LINUX_PROCESS_URL, chunk_size, label_encoders):
        rows += 1
...
if __name__ == "__main__":
    ...
    ap.add_argument("--user-id",       default="linux_process_user")
    args = ap.parse_args()
